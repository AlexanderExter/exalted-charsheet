...
export const AdvancementTab: React.FC<AdvancementTabProps> = React.memo(({ character, updateCharacter }) => {
  ...
  const getRemainingCount = (milestoneType: 'personal' | 'exalt' | 'minor' | 'major', status: AdvancementStatus) => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  <Label htmlFor="personal-accrued" className="text-xs text-gray-600">Accrued</Label>
                  <Input
                    id="personal-accrued"
                    type="number"
                ...
                <div className="text-center">
                  <div className="text-sm text-gray-600">Spent: <span className="font-bold text-blue-600">{getSpentCount("Paid with Personal")}</span></div>
                  <div className="text-sm text-gray-600">Remaining: <span className="font-bold">{getRemainingCount('personal', "Paid with Personal")}</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  <Label htmlFor="exalt-accrued" className="text-xs text-gray-600">Accrued</Label>
                  <Input
                    id="exalt-accrued"
                    type="number"
                ...
                <div className="text-center">
                  <div className="text-sm text-gray-600">Spent: <span className="font-bold text-purple-600">{getSpentCount("Paid with Exalt")}</span></div>
                  <div className="text-sm text-gray-600">Remaining: <span className="font-bold">{getRemainingCount('exalt', "Paid with Exalt")}</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  <Label htmlFor="minor-accrued" className="text-xs text-gray-600">Accrued</Label>
                  <Input
                    id="minor-accrued"
                    type="number"
                ...
                <div className="text-center">
                  <div className="text-sm text-gray-600">Spent: <span className="font-bold text-green-600">{getSpentCount("Paid with Minor")}</span></div>
                  <div className="text-sm text-gray-600">Remaining: <span className="font-bold">{getRemainingCount('minor', "Paid with Minor")}</span></div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2">
                <div>
                  <Label htmlFor="major-accrued" className="text-xs text-gray-600">Accrued</Label>
                  <Input
                    id="major-accrued"
                    type="number"
                ...
                <div className="text-center">
                  <div className="text-sm text-gray-600">Spent: <span className="font-bold text-red-600">{getSpentCount("Paid with Major")}</span></div>
                  <div className="text-sm text-gray-600">Remaining: <span className="font-bold">{getRemainingCount('major', "Paid with Major")}</span></div>
                </div>
              </div>
            </div>
          </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Button onClick={addAdvancementEntry} size="sm" className="bg-yellow-600 hover:bg-yellow-700">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <div>
                        ...
                        <Select
                          value={entry.status}
                          onValueChange={(value: AdvancementStatus) => updateAdvancementEntry(entry.id, 'status', value)}
                        >
                          <SelectTrigger>
                            <SelectValue />
                          </SelectTrigger>
                    ...
                    {entry.description !== undefined && (
                      <div>
                        ...
                        <Textarea
                          ...
                          onChange={(e) => updateAdvancementEntry(entry.id, 'description', e.target.value)}
