                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateWeapon(weapon.id, 'accuracy', Number.parseInt(e.target.value) || 0)}
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => updateWeapon(weapon.id, 'overwhelming', Number.parseInt(e.target.value) || 0)}
                        min={0}
                      />
                    </div>
                    <div>
                    ...
                    .map((tag, index) => (
                      <div key={index} className="p-2 bg-gray-50 rounded border border-gray-200">
                        ...
                        <div className="text-xs text-gray-500 mt-1">
                          Used on {[...(character?.armor || []), ...(character?.weapons || [])]
